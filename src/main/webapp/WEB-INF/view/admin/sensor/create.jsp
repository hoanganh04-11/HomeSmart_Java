        ...
        <div class="row">
            ...
            <main class="col-md-9 col-lg-10 ms-sm-auto px-md-4 py-4">
                <div class="pb-2 mb-3 border-bottom">
                    <h2><i class="bi bi-plus-circle"></i> Thêm mới Cảm biến</h2>
                </div>

                <div class="row">
                    <div class="col-md-6 col-12">
                        <form:form method="post" action="/admin/sensor/create" modelAttribute="newSensor" class="needs-validation">
                            <div class="mb-3">
                                <label class="form-label">Tên cảm biến <span class="text-danger">*</span></label>
                                <form:input type="text" class="form-control" path="name" required="required" placeholder="VD: Cảm biến nhiệt độ phòng khách" />
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <form:input type="number" step="0.1" class="form-control" path="threshold" placeholder="VD: 35.5" />
                            </div>
